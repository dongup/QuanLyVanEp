    ...
    public partial class update : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductResponse", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lots_ProductResponse_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductResponse",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialEntityId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedUserId = table.Column<int>(type: "int", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedUserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inputs_Materials_MaterialEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Outputs_Materials_MaterialEntityId",
                        column: x => x.MaterialEntityId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "b27963c0-e433-4bdb-a98d-9437b35c4845", false, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "IsDeleted", "Name", "NormalizedName" },
                values: new object[] { 2, "601aead8-a8e0-4be0-a058-7c0644993a9d", false, "User", "USER" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inputs_MaterialEntityId",
                table: "Inputs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Outputs_MaterialEntityId",
                table: "Outputs",
                column: "MaterialEntityId");
